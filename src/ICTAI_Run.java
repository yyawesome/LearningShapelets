...
public class ICTAI_Run {
    public static void main(String[] args) throws IOException{
        for(int i=0;i<Parameters.fileNames.length;i++)
        {
            ...
            ShapeletsLearner shapeletsLearner=new ShapeletsLearner((int)Parameters.para[i][0],(int)Parameters.para[i][1],Parameters.para[i][2],Parameters.para[i][3]);
